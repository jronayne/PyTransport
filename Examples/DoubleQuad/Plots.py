...
bet = np.load('dataT/bet.npy'); alp= np.load('dataT/alp.npy'); Bztot = np.load('dataT/alBetBi.npy')
Pz1tot = np.load('dataT/alBetPz1.npy'); Pz2tot=np.load('dataT/alBetPz2.npy'); Pz3tot=np.load('dataT/alBetPz3.npy')
