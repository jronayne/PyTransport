...
def pSpectra(kA, back, params, NB, MTE):
    ...
    for ii in range(0,num):
        ...
        if Nstart == np.nan:
            ...
            twoPt = MTE.sigEvolve(t,k, backExitMinus,params,0) # all data from three point run goes into threePt array
...
def eqSpectra(kA, back, params, NB, MTE):
    ...
    for ii in range(0,num):
        ...
        if Nstart == np.nan:
            ...
            threePt = MTE.alphaEvolve(t,k1,k2,k3, backExitMinus,params,0) # all data from three point run goes into threePt array
